...
import { IApp, IAttribute, IDashboard, IDatabase, IField, IFrontend, ILogin, IMicroService, IPlatform, IScreen, ISpecification } from '../types/IMetadata';
...
export class DB extends Dexie {
    ...
    async deleteDatabase() {
        await db.checkboxInputs.bulkDelete(await db.checkboxInputs.toCollection().primaryKeys());
        await db.dateInputs.bulkDelete(await db.dateInputs.toCollection().primaryKeys());
        await db.dateTimeInputs.bulkDelete(await db.dateTimeInputs.toCollection().primaryKeys());
        await db.fileInputs.bulkDelete(await db.fileInputs.toCollection().primaryKeys());

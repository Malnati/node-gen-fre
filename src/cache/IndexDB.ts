...
export class DB extends Dexie {
  ...
  platformService!: DataTableService<IPlatform>;
  appService!: DataTableService<IApp>;
  msService!: DataTableService<IMicroService>;
  dbService!: DataTableService<IStore>;
  fieldService!: DataTableService<IField>;
  screenService!: DataTableService<IScreen>;
  dashboardService!: DataTableService<IDashboard>;
  loginService!: DataTableService<ILogin>;
  frontendService!: DataTableService<IFrontend>;
  specificationService!: DataTableService<ISpecification>;
  attributeService!: DataTableService<IAttribute>;
  booleanInputService!: DataTableService<IBooleanInputProps>;
  checkboxInputsService!: DataTableService<ICheckboxGroupInputProps>;
  dateInputsService!: DataTableService<IDateInputProps>;
  dateTimeInputsService!: DataTableService<IDateTimeInputProps>;
  fileInputsService!: DataTableService<IFileInputProps>;
  imageInputsService!: DataTableService<IImageInputProps>;
  numberInputsService!: DataTableService<INumberInputProps>;
  passwordInputsService!: DataTableService<IPasswordInputProps>;
  referenceInputsService!: DataTableService<IReferenceInputProps>;
  richTextInputsService!: DataTableService<IRichTextInputProps>;
  searchInputsService!: DataTableService<ISearchInputProps>;
  selectInputsService!: DataTableService<ISelectInputProps>;
  textInputsService!: DataTableService<ITextInputProps>;
  timeInputsService!: DataTableService<ITimeInputProps>;
  translatableInputsService!: DataTableService<ITranslatableInputsProps>;
  ...
  constructor() {
    ...
    this.version(1).stores({
      ...
      dashboards:
        "++id, frontendId, name, *fields, *attributes, *specifications",
      ...
      booleanInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, options",
      checkboxInputs:
        "++id, source, className, readOnly, disabled, fullWidth, helperText, label, labelPlacement, optionValue, translateChoice, choices",
      dateInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, locale, placeholder",
      dateTimeInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, locale, placeholder",
      fileInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, accept, minSize, maxSize, multiple, placeholder",
      imageInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, accept, minSize, maxSize, multiple, placeholder",
      numberInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, step, min, max",
      passwordInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, autoComplete",
      referenceInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, reference, perPage, allowEmpty, optionValue",
      richTextInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, toolbar",
      searchInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, alwaysOn, placeholder, resettable",
      selectInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, choices, createLabel, disableValue, emptyText, emptyValue, isPending, onCreate, optionValue, resettable, translateChoice",
      textInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, type, resettable, multiline, placeholder",
      timeInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label",
      translatableInputs:
        "++id, source, className, defaultValue, readOnly, disabled, fullWidth, helperText, label, locales, defaultLocale, groupKey",
    });

    // Instanciando CRUDService para cada tabela
    this.platformService = new DataTableService(this.platforms);
    this.appService = new DataTableService(this.apps);
    this.msService = new DataTableService(this.microservices);
    this.dbService = new DataTableService(this.databases);
    this.fieldService = new DataTableService(this.fields);
    this.screenService = new DataTableService(this.screens);
    this.dashboardService = new DataTableService(this.dashboards);
    this.loginService = new DataTableService(this.logins);
    this.frontendService = new DataTableService(this.frontends);
    this.specificationService = new DataTableService(this.specifications);
    this.attributeService = new DataTableService(this.attributes);
    this.booleanInputService = new DataTableService(this.booleanInputs);
    this.checkboxInputsService = new DataTableService(this.checkboxInputs);
    this.dateInputsService = new DataTableService(this.dateInputs);
    this.dateTimeInputsService = new DataTableService(this.dateTimeInputs);
    this.fileInputsService = new DataTableService(this.fileInputs);
    this.imageInputsService = new DataTableService(this.imageInputs);
    this.numberInputsService = new DataTableService(this.numberInputs);
    this.passwordInputsService = new DataTableService(this.passwordInputs);
    this.referenceInputsService = new DataTableService(this.referenceInputs);
    this.richTextInputsService = new DataTableService(this.richTextInputs);
    this.searchInputsService = new DataTableService(this.searchInputs);
    this.selectInputsService = new DataTableService(this.selectInputs);
    this.textInputsService = new DataTableService(this.textInputs);
    this.timeInputsService = new DataTableService(this.timeInputs);
    this.translatableInputsService = new DataTableService(this.translatableInputs);

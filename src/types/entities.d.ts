...
import {
  AttributeType,
  AutocompleteInputAttributeType,
  BooleanInputAttributeType,
  CommonInputType,
  NumberInputAttributeType,
  PasswordAttributeType,
  ReferenceInputAttributeType,
  SearchInputAttributeType,
  SelectInputAttributeType,
  SpecificationType,
  TextInputAttributeType,
} from "./types";
import { IId } from "ra-multi-providers";
...
export interface ISpecification extends IId, IMetadata {
  type: SpecificationType; // Define o tipo de item relacionado
}

export interface IAttribute extends IId, IMetadata {
  type: AttributeType; // Define o tipo de item relacionado
}

export interface ICommonInputAttribute extends IId, IMetadata {
  commonType: CommonInputType;
}

export interface IReferenceInputAttribute extends IId, IMetadata {
  type: ReferenceInputAttributeType;
}

export interface IBooleanInputAttribute extends IId, IMetadata {
  type: BooleanInputAttributeType;
}

export interface ISearchInputAttribute extends IId, IMetadata {
  type: SearchInputAttributeType;
}

export interface INumberInputAttribute extends IId, IMetadata {
  type: NumberInputAttributeType;
}

export interface ITextInputAttribute extends IId, IMetadata {
  type: TextInputAttributeType;
}

export interface IRichTextInputAttribute extends IId, IMetadata {
  type: "toolbar";
}

export interface IAutocompleteInputAttribute extends IId, IMetadata {
  type: AutocompleteInputAttributeType;
}

export interface IPasswordAttribute extends IId, IMetadata {
  type: PasswordAttributeType;
}

export interface ISelectInputAttribute extends IId, IMetadata {
  type: SelectInputAttributeType;
}
...
export interface IPlatformFeature extends IId, IFeature {
  platformId: number;
}
...
export interface CommonInputProps
  extends Omit<InputProps<any>, "id" | "sx" | "format" | "parse">,
    IId {
...
export interface ICheckboxGroupInputProps
  extends Omit<CommonInputProps, "defaultValue"> {
...
export type LocaleOption =
  ...
  | "en-GB"
  | "en-CA"
  | "en-AU" // English locales
  | "pt-BR"
  | "pt-PT" // Portuguese locales
  | "es-ES"
  | "es-MX"
  | "es-AR" // Spanish locales
  | "fr-FR"
  | "fr-CA" // French locales
  | "de-DE" // German locale
  | "it-IT" // Italian locale
  | "ru-RU" // Russian locale
  | "ja-JP" // Japanese locale
  | "zh-CN"
  | "zh-TW" // Chinese locales
  | "ko-KR" // Korean locale
  | "ar-SA" // Arabic locale
  | "hi-IN" // Hindi locale
  | "he-IL" // Hebrew locale
...
export interface ISelectInputProps extends CommonInputProps {
  choices: Array<
    | { id: string | number; name: string } // Opção com `id` e `name`

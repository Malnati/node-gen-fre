...
const filters = [
    ...
    <ReferenceInput source="id" label="PasswordInput" reference="passwordInputs" />,
];

export const PasswordInputList = () => (
    <List emptyWhileLoading filters={filters} actions={<ListActions hasCreate/>}>
        <Datagrid bulkActionButtons={
            ...
            <TextField source="autoComplete" label="Step" />
            <EditButton />
            <ShowButton />

...
const filters = [
    ...
    <ReferenceInput source="id" label="RichTextInput" reference="richTextInputs" />,
];

export const RichTextInputList = () => (
    <List emptyWhileLoading filters={filters} actions={<ListActions hasCreate/>}>
        <Datagrid bulkActionButtons={
            ...
            <TextField source="toolbar" label="Toolbar" />
            <EditButton />
            <ShowButton />
